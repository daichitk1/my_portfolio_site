...
class MainPagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create main_page" do
    assert_difference("MainPage.count") do
      post main_pages_url, params: { main_page: { body: @main_page.body, title: @main_page.title } }
    end
  ...
  test "should update main_page" do
    patch main_page_url(@main_page), params: { main_page: { body: @main_page.body, title: @main_page.title } }
